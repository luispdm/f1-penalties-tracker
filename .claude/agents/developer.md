...
- Otherwise no skill is mandatory. Survey the installed skills and apply those that fit the issue: `rust-review` for risky parsing of Rust code. Some issues need none (e.g. "delete the Go tree").
